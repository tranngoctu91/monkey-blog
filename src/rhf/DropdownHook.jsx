...
const DropdownHook = ({ control, setValue, name }) => {
    ...
    return (
        ...
        <div className=' relative'>
            <div onClick={() => setShow(!show)} className='p-5 rounded-lg border border-gray-100 bg-white flex-items-center justify-between'>
                <span className='cursor-pointer'>{label || "Select your job"}</span>
            </div>
            {show && <div className='absolute top-full leff-0 w-full bg-white'>
